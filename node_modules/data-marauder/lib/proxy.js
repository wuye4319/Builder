...
class InitJs {
  ...
  changeproxy() {
    proxyindex += 1
    logger.myconsole('proxy : ' + proxyindex)
    // if (index) {
  ...
  autoproxy() {
    changeipactive = true
    console.log('Active change ip is start!')
  }
  ...
  async pipedata(type, url, process, mobile) {
    ...
    let rules = false
    let result = await pipedata.getdata(currbrow, type, url, rules, process, mobile)
