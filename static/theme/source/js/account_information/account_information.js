...
var _AccountInformation = __webpack_require__(15);
...
var AccountInformation = function (_React$Component) {
  ...
  function AccountInformation() {
    ...
    }, _this.handleSubmitName = function () {
      fetchLite(_user.updateUserInfo.bind(null, {
    ...
    }, _this.handleUpdatePassword = function () {
      fetchLite(_user.updatePassword.bind(null, {
        old_password: _this.state.oldPassword,
        password: _this.state.newPassword,
        password_confirmation: _this.state.confirmPassword
      }), {
        done: function done() {
          _Message2.default.success('Success');
        }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !!pageMode && _react2.default.createElement(
          'h2',
          { className: font('title') + ' ' + color('title') },
          'ACCOUNT INFORMATION'
        ),
        _react2.default.createElement(
          'div',
          { className: 'username-box border-line ' + color.border('hr') },
          _react2.default.createElement(
            'h3',
            { className: font('secTitle') + ' ' + color('title') },
            'USER NAME'
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_Input2.default, { type: 'text', value: name, placeholder: 'USER NAME',
        ...
        _react2.default.createElement(
          'div',
          { className: 'register-email-box border-line ' + color.border('hr') },
          _react2.default.createElement(
            'h3',
            { className: font('secTitle') + ' ' + color('title') },
            'REGISTER EMAIL'
          ...
          _react2.default.createElement(
            'p',
            { className: 'register-email ' + font('text') + ' ' + color('subText') },
            email
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'password-box border-line ' + color.border('hr') },
          _react2.default.createElement(
            'h3',
            { className: font('secTitle') + ' ' + color('title') },
          ...
          modifyPassword ? _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'warn-info ' + font('f-secTitle') + ' ' + color('title') },
                waringInfo
              ),
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: font('text') + ' ' + color('link'), onClick: this.cancelEditPassword },
                'Cancel'
              ),
              _react2.default.createElement(
                _Button2.default,
            ...
            _react2.default.createElement(
              'p',
              { className: font('text') + ' ' + color('text') },
              '*************'
            ),
            _react2.default.createElement(
              'span',
              { className: font('text') + ' ' + color('link'), onClick: this.editPassword },
              'Modify'
            )
          )
        )
