...
var _AccountInformation = __webpack_require__(14);

var _AccountInformation2 = _interopRequireDefault(_AccountInformation);
...
var _module = { AccountInformation: _AccountInformation2.default };

var config = __webpack_require__(41);

var UserCenterAccountInformation = function (_React$Component) {
  _inherits(UserCenterAccountInformation, _React$Component);

  function UserCenterAccountInformation() {
    _classCallCheck(this, UserCenterAccountInformation);

    return _possibleConstructorReturn(this, (UserCenterAccountInformation.__proto__ || Object.getPrototypeOf(UserCenterAccountInformation)).apply(this, arguments));
  }

  _createClass(UserCenterAccountInformation, [{
    key: 'render',
  ...
  return UserCenterAccountInformation;
}(_react2.default.Component);

window.wrapper(UserCenterAccountInformation, config);
...
var AccountInformation = function (_React$Component) {
  _inherits(AccountInformation, _React$Component);
  ...
  function AccountInformation() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AccountInformation.__proto__ || Object.getPrototypeOf(AccountInformation)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      userName: 'Oldox@staritgp.com',
      email: '',
      initPassword: '',
      oldPassword: '',
      newPassword: '',
      ...
      waringInfo: ''
    }, _this.handleChangeValue = function (key, e) {
    ...
    }, _this.cancelEditPassword = function () {
      _this.setState(function () {
        return {
          modifyPassword: false
        };
      ...
      _this.props.fetch('/member/').then(function (res) {
        if (res.state === 0) {
          var _res$data = res.data,
              name = _res$data.name,
              email = _res$data.email,
              password = _res$data.password;
  ...
  _createClass(AccountInformation, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          email = _state.email,
          modifyPassword = _state.modifyPassword,
          oldPassword = _state.oldPassword,
          newPassword = _state.newPassword,
          confirmPassword = _state.confirmPassword,
          waringInfo = _state.waringInfo;

      return _react2.default.createElement(
        'div',
        { className: 'm-account-information-wrap' },
        ...
        _react2.default.createElement(
          'div',
          { className: 'username-box border-line ' + _util.color.border('hr') },
          _react2.default.createElement(
            'h3',
            { className: (0, _util.font)('secTitle') + ' ' + (0, _util.color)('title') },
            'USER NAME'
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_Input2.default, { type: 'text', value: userName, placeholder: 'USER NAME',
                onChange: this.handleChangeValue.bind(this, 'userName') })
            ),
            _react2.default.createElement(
              _Button2.default,
              null,
        ...
        _react2.default.createElement(
          'div',
          { className: 'register-email-box border-line ' + _util.color.border('hr') },
          _react2.default.createElement(
            'h3',
            { className: (0, _util.font)('secTitle') + ' ' + (0, _util.color)('title') },
            'REGISTER EMAIL'
          ...
          _react2.default.createElement(
            'p',
            { className: 'register-email ' + (0, _util.font)('text') + ' ' + (0, _util.color)('subText') },
            email
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'password-box border-line ' + _util.color.border('hr') },
          _react2.default.createElement(
            'h3',
            { className: (0, _util.font)('secTitle') + ' ' + (0, _util.color)('title') },
            modifyPassword ? 'MODIFY PASSWORD' : 'PASSWORD'
          ),
          modifyPassword ? _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'warn-info ' + (0, _util.font)('f-secTitle') + ' ' + (0, _util.color)('title') },
                waringInfo
              ),
              _react2.default.createElement(_Input2.default, { type: 'password', value: oldPassword, placeholder: 'OLD PASSWORD',
                onChange: this.handleChangeValue.bind(this, 'oldPassword') }),
              _react2.default.createElement(_Input2.default, { type: 'password', value: newPassword, placeholder: 'NEW PASSWORD',
                onChange: this.handleChangeValue.bind(this, 'newPassword') }),
              _react2.default.createElement(_Input2.default, { type: 'password', value: confirmPassword, placeholder: 'CONFIRM PASSWORD',
                onChange: this.handleChangeValue.bind(this, 'confirmPassword') })
            ),
            _react2.default.createElement(
              'div',
              { className: 'operate-section' },
              _react2.default.createElement(
                'span',
                { className: (0, _util.font)('text') + ' ' + (0, _util.color)('link'), onClick: this.cancelEditPassword },
                'Cancel'
              ),
              _react2.default.createElement(
                _Button2.default,
            ...
            _react2.default.createElement(
              'p',
              { className: (0, _util.font)('text') + ' ' + (0, _util.color)('text') },
              '*************'
            ),
            _react2.default.createElement(
              'span',
              { className: (0, _util.font)('text') + ' ' + (0, _util.color)('link'), onClick: this.editPassword },
              'Modify'
            )
          )
        )
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./AccountInformation.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./AccountInformation.less");
...
// module
exports.push([module.i, "/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-account-information-wrap {\n  width: 100%;\n}\n.m-account-information-wrap .border-line {\n  border-bottom-width: 0.01rem;\n  border-bottom-style: solid;\n  padding: 0.4rem 0.2rem;\n}\n.m-account-information-wrap .border-line h3 {\n  margin-bottom: 0.1rem;\n}\n.m-account-information-wrap .username-box .username {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.m-account-information-wrap .username-box .username .username-input {\n  flex: 1;\n  max-width: 6rem;\n}\n.m-account-information-wrap .username-box .username .username-input .bc-input {\n  width: 100%;\n}\n.m-account-information-wrap .username-box .username .bc-button {\n  margin-left: 14%;\n}\n.m-account-information-wrap .password-box .modify-password {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.m-account-information-wrap .password-box .modify-password span {\n  cursor: pointer;\n}\n.m-account-information-wrap .password-box .modify-password .password-list {\n  flex: 1;\n  max-width: 6rem;\n}\n.m-account-information-wrap .password-box .modify-password .password-list .warn-info {\n  margin-bottom: 0.1rem;\n  color: #FF6158;\n  height: 0.24rem;\n  line-height: 0.24rem;\n}\n.m-account-information-wrap .password-box .modify-password .password-list .bc-input {\n  width: 100%;\n  margin-bottom: 0.2rem;\n}\n.m-account-information-wrap .password-box .modify-password .password-list .bc-input:last-of-type {\n  margin-bottom: 0;\n}\n.m-account-information-wrap .password-box .modify-password .operate-section {\n  margin-left: 14%;\n  height: 2.18rem;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n  padding-top: 0.34rem;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n}\n@media screen and (max-width: 749px) {\n  .m-account-information-wrap h2 {\n    text-align: center;\n    padding-top: 0.4rem;\n  }\n  .m-account-information-wrap .border-line {\n    padding: 0.4rem 0;\n  }\n  .m-account-information-wrap .username-box .username .bc-button {\n    margin-left: 11%;\n  }\n  .m-account-information-wrap .password-box .modify-password .operate-section {\n    margin-left: 11%;\n  }\n}\n", ""]);
...
module.exports = {"name":"accountinformation","userCenter":"account","module":[{"name":"AccountInformation","key":1}]}
