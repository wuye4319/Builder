...
var _BlogDetails = __webpack_require__(12);
...
window.wrapper(Blogdetails, config);
...
var BlogDetails = function (_React$Component) {
  ...
  function BlogDetails() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BlogDetails.__proto__ || Object.getPrototypeOf(BlogDetails)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      labelList: [{
        label: 'Simple'
      }, {
        label: 'Atmosphere'
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !pageMode && _react2.default.createElement(
          'div',
          { className: 'nav-wrap  ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
          _react2.default.createElement(
            _Link2.default,
            { className: 'sup-nav ' + (0, _util.color)('text'), href: '/page/blogs' },
            'My Blog'
          ),
        ...
        _react2.default.createElement(
          'h2',
          { className: 'blog-title ' + (0, _util.color)('title') + ' ' + (0, _util.font)('title') },
          'Closed month shame flower'
        ),
        _react2.default.createElement(
          'div',
          { className: 'blog-info ' + (0, _util.color)('subText') + ' ' + (0, _util.font)('text') },
          _react2.default.createElement(
            'span',
            { className: 'date' },
            'May 18,2018'
        ...
        _react2.default.createElement(
          ...
          labelList.map(function (item, key) {
            return _react2.default.createElement(
              'span',
              { className: ' ' + (0, _util.color)('subText') + ' ' + (0, _util.font)('subText') + ' ' + _util.color.border('hr'),
                key: key },
              item.label
            );
          })
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            'The simple atmosphere of logs is a kind of feeling that I can never give up. It is like the embrace of Mother Nature. It seems that as long as they watch their lives, they can return to the most natural and most comfortable moment. Perhaps this is the charm of logs.'
          ),
          _react2.default.createElement(
            'p',
            { className: ' ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
            'Snapchat is one of the most popular social media channels, especially in young adults, and there are many unique features on the platform that you stumble across when you use it. One of the features is the Snapchat friend\'s emoji. You may ask yourself: "What does Snapchat emoji mean?"'
          ),
          _react2.default.createElement(
            'p',
            { className: ' ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
            'If you are an active Snapchat user, you may notice these emojis. They appear next to your friend\'s name on the "Friends" tab and they provide some interesting insights into how you and your friends interact with Snapchat.'
          ),
          _react2.default.createElement(
            'p',
            { className: ' ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
            'In this article, we will explain everything you need to know about emojis on Snapchat, and we will highlight the meaning of each Snapchat emoji - if you are an active user like me, you must read it.'
          ),
          _react2.default.createElement(
            'p',
            { className: ' ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
          ...
          _react2.default.createElement('img', { src: '/source/img/photo_12.png',
            alt: 'blogImg' })
        ),
        !pageMode && _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'previous-box ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
            _react2.default.createElement(
              'span',
              null,
              'Previous: '
            ...
            _react2.default.createElement(
              'a',
              { href: 'javascript:;', className: 'disable ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
              'No More'
            )
          ),
          _react2.default.createElement(
            'div',
            { className: 'next-box ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
            _react2.default.createElement(
              'span',
              null,
              'Next:'
            ...
            _react2.default.createElement(
              'a',
              { href: 'javascript:;', className: (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
...
module.exports = {"name":"blogdetails","module":[{"name":"BlogDetails","key":1}]}
