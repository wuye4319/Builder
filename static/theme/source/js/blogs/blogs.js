...
var _module = { Blogs: _Blogs2.default
  /** modules **/
...
var Blogs = function (_React$Component) {
  ...
  function Blogs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Blogs.__proto__ || Object.getPrototypeOf(Blogs)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _this.getBlogData(page, pageSize).then(function (res) {
        if (res.state === 0) {
          var data = res.data,
              total = res.total,
    ...
    }, _this.createData = function (cols, rows, pageMode) {
  ...
  _createClass(Blogs, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'm-blogs-box' },
        _react2.default.createElement(
          'div',
          { className: 'm-blogs-wrap l-mobile-blogs-wrap l-centerBlock' },
          ...
          !pageMode && _react2.default.createElement('div', { className: 'line ' + _util.color.bg('hr') }),
          !pageMode && _react2.default.createElement(
            'div',
            { className: 'blog-note ' + (0, _util.color)('subText') + ' ' + (0, _util.font)('text') },
            _react2.default.createElement(
              'p',
              null,
              '\u70ED\u95E8\u7F8E\u56FE'
                    ...
                    return _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          ...
                          _react2.default.createElement(
                            'div',
                            { className: 'date-author ' + (0, _util.font)('subText') + ' ' + (0, _util.color)('subText') },
                            _react2.default.createElement(
                              'span',
                              { className: 'date' },
                              val['edit_date']
                          ...
                          _react2.default.createElement(
                            'h2',
                            { className: (0, _util.color)('subTitle') + ' ' + (0, _util.font)('subTitle') },
                            val.title
                          )
                        )
                      )
          ...
          totalPage > pageSize || _react2.default.createElement(_Pagination2.default, {
            onEndReached: 0,
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Blogs.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Blogs.less");
