...
var _EmailResult = __webpack_require__(15);

var _EmailResult2 = _interopRequireDefault(_EmailResult);
...
var _module = { EmailResult: _EmailResult2.default
  /** modules **/
  // const config = require('./config.json')

};
var Email_result = function (_React$Component) {
  _inherits(Email_result, _React$Component);

  function Email_result() {
    _classCallCheck(this, Email_result);

    return _possibleConstructorReturn(this, (Email_result.__proto__ || Object.getPrototypeOf(Email_result)).apply(this, arguments));
  }

  _createClass(Email_result, [{
    key: 'render',
...
var EmailResult = function (_React$Component) {
  _inherits(EmailResult, _React$Component);
  ...
  function EmailResult() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EmailResult.__proto__ || Object.getPrototypeOf(EmailResult)).call.apply(_ref, [this].concat(args))), _this), _this.sendAgain = function () {
      _Message2.default.success('再发一次邮件');
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(EmailResult, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'm-email-result-wrap  l-centerBlock2' },
        _react2.default.createElement(
          'div',
          { className: 'email-result-box' },
          _react2.default.createElement(_Icon2.default, { type: 'yes-filling' }),
          _react2.default.createElement(
            'h2',
          ...
          _react2.default.createElement(
            'p',
            { className: 'desc ' + (0, _util.font)('text') + ' ' + (0, _util.color)('text') },
            'Your request to reset your password has been received We will shortly email you the details on how to reset your password Please follow the instructions on this email'
          ),
          _react2.default.createElement(
            'p',
            { className: 'tips ' + (0, _util.font)('text') + ' ' + (0, _util.color)('text') },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: (0, _util.color)('title') + ' ' + (0, _util.font)('secTitle') },
                'Login'
              ),
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./EmailResult.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./EmailResult.less");
...
// module
exports.push([module.i, "/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-email-result-wrap .email-result-box {\n  width: 100%;\n  text-align: center;\n}\n.m-email-result-wrap .email-result-box .bc-icon-yes-filling {\n  display: block;\n  font-size: 1.2rem;\n  color: #29CA40;\n  margin: 0.8rem 0 0.4rem;\n}\n.m-email-result-wrap .email-result-box h2 {\n  margin-bottom: 0.2rem;\n}\n.m-email-result-wrap .email-result-box p.desc {\n  width: 4.82rem;\n  margin: 0 auto 0.36rem;\n}\n.m-email-result-wrap .email-result-box p.tips {\n  margin-bottom: 0.2rem;\n}\n.m-email-result-wrap .email-result-box .toLogin {\n  margin: 0.33rem 0 0.2rem;\n}\n.m-email-result-wrap .email-result-box .toLogin .c-icon {\n  font-size: 0.12rem;\n  color: #8B8185;\n  margin-left: 0.1rem;\n}\n@media screen and (max-width: 749px) {\n  .m-email-result-wrap .email-result-box .bc-icon-yes-filling {\n    display: block;\n    font-size: 1.2rem;\n    color: #29CA40;\n    margin: 0.4rem 0 0.2rem;\n  }\n  .m-email-result-wrap .email-result-box p.desc {\n    width: 100%;\n  }\n}\n", ""]);
