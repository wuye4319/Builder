...
var _module = { Login: _Login2.default
  /** modules **/
...
var Login = function (_React$Component) {
  ...
  function Login() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Login.__proto__ || Object.getPrototypeOf(Login)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.handleCheckPassword = function () {
      ...
      (0, _util.fetchLite)(_user.login.bind(null, { eMail: eMail, passWord: passWord }), {
        done: function done() {
          var ref = (0, _util.query2Obj)().ref;
          _Link2.default.goTo(ref ? decodeURIComponent(ref) : '/account_information/');
        }
      });
    }, _this.goRegister = function () {
      _Link2.default.goTo('/register');
  ...
  _createClass(Login, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'm-Login-wrap  l-centerBlock' },
        _react2.default.createElement(
          'div',
          { className: 'login-start' },
          _react2.default.createElement(
            'h2',
            { className: 'login-title ' + (0, _util.font)('title') + ' ' + (0, _util.color)('title') },
            'CUSTOMER LOGIN'
          ),
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Button2.default,
              { type: 'ghost', onClick: this.goRegister },
              'CREATE ACCOUNT'
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Link2.default,
              { href: '/send_email', className: (0, _util.color)('subText') + ' ' + (0, _util.font)('text') },
...
// module
exports.push([module.i, "/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-Login-wrap .login-start {\n  width: 6rem;\n  margin: 0 auto;\n  overflow: hidden;\n}\n.m-Login-wrap .login-start .login-title {\n  text-align: center;\n  margin: 0.8rem 0 0.42rem;\n}\n.m-Login-wrap .login-start .warn-info {\n  margin: 0 auto;\n  margin-bottom: 0.2rem;\n  color: #FF6158;\n  height: 0.24rem;\n  line-height: 0.24rem;\n}\n.m-Login-wrap .login-start h3 {\n  margin-bottom: 0.1rem;\n}\n.m-Login-wrap .login-start .bc-input {\n  width: 100%;\n  margin-bottom: 0.2rem;\n}\n.m-Login-wrap .login-start .warning.bc-input {\n  border: 1px solid #D1343E;\n}\n.m-Login-wrap .login-start div.sign,\n.m-Login-wrap .login-start div.create {\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n  margin-bottom: 0.2rem;\n}\n.m-Login-wrap .login-start div.sign button,\n.m-Login-wrap .login-start div.create button {\n  width: 100%;\n}\n.m-Login-wrap .login-start .forgot-password {\n  text-align: center;\n  margin-bottom: 0.2rem;\n}\n.m-Login-wrap .login-start .forgot-password a {\n  text-decoration: underline;\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n}\n@media screen and (max-width: 749px) {\n  .m-Login-wrap .login-start {\n    width: 100%;\n    padding: 0 0.2rem;\n    -webkit-box-sizing: border-box;\n    -moz-box-sizing: border-box;\n    box-sizing: border-box;\n  }\n  .m-Login-wrap .login-start .login-title {\n    margin: 0.4rem 0 0.22rem;\n  }\n}\n", ""]);
