...
var _OrderDetails = __webpack_require__(15);
...
var statusMap = ['Unpaid', 'Authorized', 'Paid', 'Processing', 'Dispatched', 'Receipted', 'Reviewed', 'Completed', 'Closed'];
...
var OrderDetails = function (_React$Component) {
  ...
  function OrderDetails() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderDetails.__proto__ || Object.getPrototypeOf(OrderDetails)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      (0, _util.fetchLite)(_user.orderDetails.bind(null, id), {
    ...
    value: function render() {
      ...
      if (data) {
        var orderNumber = data.order_number,
            ...
            status = data.status;
        var firstName = shippingAddress.first_name,
        ...
        var items = function () {
          var item1 = data.unfulfilled ? data.unfulfilled.order_items || [] : [];
          var item2 = data.fulfilled ? data.fulfilled[0].order_items : [];
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Link2.default,
              { href: '/orders/', className: '' + (0, _util.color)('text') },
              'My Orders'
            ),
