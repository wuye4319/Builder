...
var _OrderDetails = __webpack_require__(14);
...
var _module = { OrderDetails: _OrderDetails2.default
  /** modules **/
...
window.wrapper(OrdersPage, config);
...
var OrderDetails = function (_React$Component) {
  ...
  function OrderDetails() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderDetails.__proto__ || Object.getPrototypeOf(OrderDetails)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _this.props.fetch('/orders/' + id).then(function (data) {
        console.log(data);
        if (data.state === 0) {
  ...
  _createClass(OrderDetails, [{
    ...
    value: function componentWillMount() {
      this.getData((0, _util.query2Obj)().id);
    }
  }, {
    key: 'render',
    value: function render() {
      var classPrefix = OrderDetails.classPrefix;
      ...
      if (data) {
        var id = data.order_id,
            ...
            itemsPrice = data.total_items_price,
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: classPrefix + '-crumbs ' + (0, _util.font)('text') },
            _react2.default.createElement(
              _Link2.default,
              { href: '/page/orders/', className: '' + (0, _util.color)('text') },
              'My Orders'
            ),
            _react2.default.createElement(_Icon2.default, { type: 'forward', color: 'subText' }),
            _react2.default.createElement(
              'span',
              { className: '' + (0, _util.color)('subText') },
              'Order Details'
            )
          ),
          _react2.default.createElement(
            'div',
            { className: classPrefix + '-status ' + _util.color.border('border') + ' l-centerBlock2 mobile-item' },
            _react2.default.createElement(
              'p',
              null,
              'Order Status'
            ...
            _react2.default.createElement(
              'h2',
              { className: classPrefix + '-status-title ' + (0, _util.color)('title') + ' ' + (0, _util.font)('title') },
              _react2.default.createElement(
                'span',
                null,
                'CANCELLED'
            ...
            _react2.default.createElement(
              'span',
              { className: '' + (0, _util.color)('subText') },
              'Expired payment, system has automatically canceled the order for you.'
            )
          ),
          _react2.default.createElement(
            'div',
            { className: classPrefix + '-bottom ' + _util.color.border('hr') + ' ' + _util.color.bg('bg') + ' mobile-item' },
            _react2.default.createElement(
              _Button2.default,
              { type: 'ghost' },
              'DELETE ORDER'
          ...
          _react2.default.createElement(
            'div',
            { className: classPrefix + '-infoBlock ' + _util.color.border('border') },
            _react2.default.createElement(
              'div',
              { className: classPrefix + '-info ' + _util.color.bg('subBg') },
              _react2.default.createElement(
                'h3',
                { className: (0, _util.color)('title') + ' ' + (0, _util.font)('subTitle') + ' pc-item' },
                'Order number ',
                id
              ),
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'p',
                    { className: '' + (0, _util.color)('subText'), style: { marginTop: pageMode ? 5 : 15 } },
                    [address, suite, city, province, country].filter(function (item) {
                      return item;
                    }).join(', ')
                  )
                )
              ...
              !!payment && _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'dd',
                  { className: classPrefix + '-info-payment' },
                  _react2.default.createElement(
                    'strong',
                    null,
                    payment.pay_channel,
                  ...
                  _react2.default.createElement(
                    'strong',
                    null,
                    !!payment.payer_account && '****' + payment.payer_account.slice(-3)
                  )
                )
              )
            ),
            _react2.default.createElement(
              'div',
              { className: classPrefix + '-status ' + _util.color.border('border') + ' pc-item' },
              _react2.default.createElement(
                'p',
                null,
                'Order Status'
              ...
              _react2.default.createElement(
                'div',
                { className: classPrefix + '-status-button' },
                _react2.default.createElement(
                  _Button2.default,
                  { type: 'ghost' },
                  'DELETE ORDER'
          ...
          _react2.default.createElement(
            'h2',
            { className: classPrefix + '-title ' + (0, _util.color)('title') + ' ' + (0, _util.font)('subTitle') + ' pc-item' },
            'Delivery Information'
          ),
          _react2.default.createElement('i', { className: classPrefix + '-delivery-hr ' + _util.color.border('hr') + ' mobile-item' }),
          _react2.default.createElement(
            'div',
            { className: classPrefix + '-delivery ' + _util.color.border('border') + ' ' + (0, _util.setClass)(_defineProperty({}, _util.color.bg('subBg'), pageMode)) },
            _react2.default.createElement(
              'dl',
              null,
              _react2.default.createElement(
            ...
            _react2.default.createElement(
              'dl',
              { className: classPrefix + '-logistics' },
              _react2.default.createElement(
                'dt',
                { className: '' + (0, _util.color)('subText') },
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  null,
                  _react2.default.createElement('i', { className: 'top-dot' }),
                  _react2.default.createElement('i', { className: 'bottom-dot' })
                ),
                _react2.default.createElement(
                  'ul',
                  null,
                  _react2.default.createElement(
                    'li',
                    { className: '' + _util.color.border('hr') },
                    _react2.default.createElement(
                      'p',
                      null,
                      '[Shenzhen] Your order has arrived [Shenzhen Peace Station]'
                    ),
                    _react2.default.createElement(
                      'span',
                      { className: '' + (0, _util.color)('subText') },
          ...
          _react2.default.createElement(
            'div',
            { className: classPrefix + '-products ' + _util.color.border('border') },
            _react2.default.createElement(
              'div',
              { className: classPrefix + '-products-title ' + _util.color.border('hr') + ' ' + (0, _util.font)('secTitle') + ' pc-item' },
              _react2.default.createElement(
                'p',
                null,
                'PRODUCT'
            ...
            _react2.default.createElement(
              'ul',
              null,
              !!(items && items.length) && items.map(function (_ref2) {
                var id = _ref2.product_id,
                    img = _ref2.product_img,
                    name = _ref2.product_name,
                    quantity = _ref2.quantity,
                    sku = _ref2.sku_code,
                    spu = _ref2.spu_code,
                    price = _ref2.unit_price,
                    currency = _ref2.currency_symbol,
                    remark = _ref2.item_remark;

                return _react2.default.createElement(
                  'li',
                  { className: '' + _util.color.border('hr'), key: id + spu + sku },
                  _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                      _Link2.default,
                      { href: '/page/products/?id=' + id },
                  ...
                  _react2.default.createElement(
                    ...
                    { className: 'pc-item' },
                    currency,
                    (0, _util.formatPrice)(price * quantity, true)
                  )
                );
              })
            )
          ...
          _react2.default.createElement(
            'div',
            { className: classPrefix + '-total ' + _util.color.bg('subBg') + ' clearfix' },
            _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'dt',
                  { className: '' + (0, _util.font)('subTitle') },
                  'Total'
                ),
                _react2.default.createElement(
                  'dd',
...
OrderDetails.classPrefix = 'm-orderDetails';
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./OrderDetails.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./OrderDetails.less");
...
// module
exports.push([module.i, "/** Search **/\n/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-orderDetails-crumbs {\n  padding: 0.35rem 0;\n  line-height: 0.25rem;\n}\n.m-orderDetails-crumbs a {\n  text-decoration: underline;\n}\n.m-orderDetails-crumbs .bc-icon {\n  font-size: 12px;\n  margin: 0 0.12rem 0 0.1rem;\n}\n.m-orderDetails-infoBlock {\n  border-width: 1px;\n  border-style: solid;\n  display: flex;\n}\n.m-orderDetails-infoBlock > div {\n  padding: 0.35rem 0.2rem;\n}\n.m-orderDetails-infoBlock .m-orderDetails-info {\n  width: 53.33%;\n  flex-shrink: 0;\n}\n.m-orderDetails-infoBlock .m-orderDetails-status {\n  border-left-width: 1px;\n  border-left-style: solid;\n}\n.m-orderDetails-info {\n  width: 53.33%;\n  flex-shrink: 0;\n}\n.m-orderDetails-info h3 {\n  margin-bottom: 0.3rem;\n}\n.m-orderDetails-info dl {\n  display: flex;\n  margin: 0.2rem 0;\n}\n.m-orderDetails-info dl dt {\n  width: 1.76rem;\n  flex-shrink: 0;\n}\n.m-orderDetails-info dl:last-of-type {\n  margin-bottom: 0;\n}\n.m-orderDetails-info-payment img {\n  height: 0.25rem;\n  width: auto;\n  border: 1px solid #ddd;\n  background: #fff;\n  vertical-align: middle;\n  padding: 0.03rem 0.05rem;\n  margin-right: 0.2rem;\n}\n.m-orderDetails-status-title {\n  margin: 0.1rem 0 0.05rem 0;\n}\n.m-orderDetails-status-title span {\n  font-size: 1.2em;\n  font-weight: bold;\n  letter-spacing: 0;\n}\n.m-orderDetails-status-button .bc-button {\n  margin-top: 0.2rem;\n}\n.m-orderDetails-status-button .bc-button:first-of-type {\n  margin-right: 0.2rem;\n}\n.m-orderDetails-title {\n  margin-top: 0.35rem;\n}\n.m-orderDetails-delivery {\n  border-width: 1px;\n  border-style: solid;\n  margin-top: 0.15rem;\n  padding: 0.35rem 0.2rem;\n}\n.m-orderDetails-delivery dl {\n  display: flex;\n  margin: 0.2rem 0;\n}\n.m-orderDetails-delivery dl dt {\n  width: 1.76rem;\n  flex-shrink: 0;\n}\n.m-orderDetails-delivery dl dd {\n  flex-grow: 1;\n}\n.m-orderDetails-delivery dl:first-of-type {\n  margin-top: 0;\n}\n.m-orderDetails-delivery dl:last-of-type {\n  margin-bottom: 0;\n}\n.m-orderDetails-logistics dd {\n  display: flex;\n  margin-top: 0.15rem;\n}\n.m-orderDetails-logistics dd > div {\n  width: 56px;\n  flex-shrink: 0;\n  margin: 0.26rem 0;\n  position: relative;\n}\n.m-orderDetails-logistics dd > div i {\n  position: absolute;\n  left: 0;\n  width: 21px;\n  height: 21px;\n  border-radius: 50%;\n}\n.m-orderDetails-logistics dd > div i.top-dot {\n  background: rgba(24, 144, 255, 0.3);\n  top: -6px;\n}\n.m-orderDetails-logistics dd > div i.top-dot:after {\n  content: '';\n  display: block;\n  width: 9px;\n  height: 9px;\n  border-radius: 50%;\n  background: #1890ff;\n  margin: 6px 0 0 6px;\n}\n.m-orderDetails-logistics dd > div i.bottom-dot {\n  background: #EBE5E7;\n  bottom: -6px;\n}\n.m-orderDetails-logistics dd > div:before {\n  content: '';\n  display: block;\n  width: 1px;\n  height: 100%;\n  margin-left: 10px;\n  background: #EBE5E7;\n}\n.m-orderDetails-logistics dd ul {\n  flex-grow: 1;\n}\n.m-orderDetails-logistics dd li {\n  padding: 0.18rem 0;\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n}\n.m-orderDetails-logistics dd li span {\n  margin-top: 0.12rem;\n  display: block;\n}\n.m-orderDetails-logistics dd li:first-of-type {\n  padding-top: 0;\n}\n.m-orderDetails-logistics dd li:last-of-type {\n  padding-bottom: 0;\n  border: 0;\n}\n.m-orderDetails-products {\n  border-width: 1px;\n  border-style: solid;\n  margin-top: 0.15rem;\n  padding: 0.35rem 0.2rem;\n}\n.m-orderDetails-products-title {\n  display: flex;\n  padding-bottom: 0.2rem;\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n}\n.m-orderDetails-products-title > p {\n  width: 18%;\n  flex-shrink: 0;\n}\n.m-orderDetails-products-title > p:first-of-type {\n  width: 50%;\n  padding-right: 0.2rem;\n}\n.m-orderDetails-products-title > p:last-of-type {\n  width: 14%;\n}\n.m-orderDetails-products li {\n  padding: 0.2rem 0;\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n  display: flex;\n  align-items: center;\n}\n.m-orderDetails-products li img {\n  width: 1.2rem;\n  display: block;\n}\n.m-orderDetails-products li > div {\n  width: 18%;\n  flex-shrink: 0;\n}\n.m-orderDetails-products li > div:first-of-type {\n  width: 50%;\n  padding-right: 0.2rem;\n  display: flex;\n  align-items: center;\n}\n.m-orderDetails-products li > div:last-of-type {\n  width: 14%;\n}\n.m-orderDetails-products li:last-of-type {\n  padding-bottom: 0;\n  border-bottom-width: 0;\n}\n.m-orderDetails-products li .item-desc {\n  margin-left: 4%;\n}\n.m-orderDetails-products li .item-desc p {\n  margin: 0.1rem 0;\n}\n.m-orderDetails-total {\n  margin-top: 0.4rem;\n  margin-bottom: 0.8rem;\n  padding: 0.2rem 0.4rem;\n}\n.m-orderDetails-total > div {\n  float: right;\n  width: 100%;\n  max-width: 4rem;\n}\n.m-orderDetails-total dl {\n  display: flex;\n  margin: 0.2rem 0;\n}\n.m-orderDetails-total dl dd {\n  text-align: right;\n  flex-grow: 1;\n}\n.m-orderDetails-total dl:last-of-type {\n  border-top-width: 1px;\n  border-top-style: solid;\n  padding-top: 0.2rem;\n  margin-bottom: 0;\n}\n.m-orderDetails-total dl:last-of-type dd span {\n  margin-right: 0.04rem;\n}\n.m-orderDetails-total dl:last-of-type dt,\n.m-orderDetails-total dl:last-of-type dd {\n  line-height: 0.4rem;\n}\n.m-orderDetails .mobile-item {\n  display: none;\n}\n.m-orderDetails-bottom {\n  position: fixed;\n  width: 100%;\n  height: 0.7rem;\n  border-top-style: solid;\n  border-top-width: 1px;\n  padding: 0.1rem 10px 0 10px;\n  left: 0;\n  bottom: 0;\n  text-align: right;\n  z-index: 2;\n}\n.m-orderDetails-bottom .bc-button {\n  margin-left: 10px;\n}\n.m-orderDetails-bottom .bc-button:first-of-type {\n  margin-left: 0;\n}\n.l-mobile .m-orderDetails .pc-item {\n  display: none;\n}\n.l-mobile .m-orderDetails .mobile-item {\n  display: block;\n}\n.l-mobile .m-orderDetails-crumbs {\n  margin-left: 20px;\n  padding: 0.2rem 0;\n}\n.l-mobile .m-orderDetails-infoBlock {\n  border: 0;\n}\n.l-mobile .m-orderDetails-info {\n  width: 100%;\n  padding: 0.2rem 20px;\n  margin-top: 0.2rem;\n}\n.l-mobile .m-orderDetails-info dl {\n  margin: 0.15rem 0;\n}\n.l-mobile .m-orderDetails-info dl:first-of-type {\n  margin-top: 0;\n  display: block;\n}\n.l-mobile .m-orderDetails-info dl:first-of-type dt {\n  width: 100%;\n  margin-bottom: 0.05rem;\n}\n.l-mobile .m-orderDetails-info dl:last-of-type {\n  margin-bottom: 0;\n}\n.l-mobile .m-orderDetails-delivery {\n  border: 0;\n  margin-top: 0;\n  padding: 0.2rem 20px;\n}\n.l-mobile .m-orderDetails-delivery-hr {\n  display: block;\n  border-top: 1px solid #ddd;\n  margin: 0 20px;\n  border-top-width: 1px;\n  border-top-style: solid;\n}\n.l-mobile .m-orderDetails-delivery dl {\n  margin: 0.15rem 0;\n}\n.l-mobile .m-orderDetails-delivery dl:first-of-type {\n  margin-top: 0;\n}\n.l-mobile .m-orderDetails-logistics {\n  display: block;\n}\n.l-mobile .m-orderDetails-logistics dd > div {\n  width: 44px;\n  margin-left: 0.16rem;\n}\n.l-mobile .m-orderDetails-products {\n  border: 0;\n  margin-top: 0;\n}\n.l-mobile .m-orderDetails-products li:first-of-type {\n  padding-top: 0;\n}\n.l-mobile .m-orderDetails-products li:last-of-type {\n  padding-bottom: 0.2rem;\n  border-bottom-width: 1px;\n}\n.l-mobile .m-orderDetails-products li > div:nth-of-type(1) {\n  width: 80%;\n  padding-right: 0;\n}\n.l-mobile .m-orderDetails-products li > div:nth-of-type(2) {\n  width: 20%;\n  text-align: right;\n}\n.l-mobile .m-orderDetails-total {\n  margin: 0 20px 0.4rem 20px;\n  padding: 0.1rem 0.2rem;\n}\n.l-mobile .m-orderDetails-total > div {\n  max-width: none;\n}\n.l-mobile .l-footer {\n  padding-bottom: 0.7rem;\n}\n", ""]);
...
module.exports = {"name":"orderdetails","module":[{"name":"OrderDetails","key":1}]}
