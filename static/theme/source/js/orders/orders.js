...
var _module = { Orders: _Orders2.default
  /** modules **/
...
var Orders = function (_React$Component) {
  ...
  function Orders() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Orders.__proto__ || Object.getPrototypeOf(Orders)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      data: [],
      pageSize: 10,
      page: 1,
      total: 0,
      totalPage: 1
    }, _this.getData = function (n) {
      ...
      return (0, _user.getOrders)(pageSize, n || page).then(function (data) {
        if (data.state === 0) {
          var _data = data.data;
          var list = _data.data || [];
    ...
    }, _this.handleChangePage = function (n) {
      return _this.getData(n);
  ...
  _createClass(Orders, [{
    ...
    key: 'render',
    value: function render() {
      var classPrefix = Orders.classPrefix;
      ...
      return _react2.default.createElement(
        ...
        data && data.length ? _react2.default.createElement(
          ...
          pageMode ? '' : _react2.default.createElement(
            'div',
            { className: classPrefix + '-header ' + _util.color.border('hr') + ' ' + (0, _util.color)('text') + '  ' + (0, _util.font)('subTitle') },
          ...
          _react2.default.createElement(
            ...
            pageMode ? data.map(function (item) {
              return _react2.default.createElement(OrderItemMobile, { data: item, key: item.id });
            }) : data.map(function (item) {
              return _react2.default.createElement(OrderItem, { data: item, key: item.id });
            })
          ),
          ...
          'div',
          { className: classPrefix + '-none' },
          _react2.default.createElement('i', null),
          _react2.default.createElement(
            'p',
            { className: (0, _util.color)('title') + ' ' + (0, _util.font)('subTitle') },
            'You haven\'t placed any orders yet.'
          ),
          _react2.default.createElement(
            _Button2.default,
            { href: '/home/', type: 'ghost' },
            'Continue Shopping'
          )
        )
      );
...
Orders.classPrefix = 'm-orders';
exports.default = Orders;
var OrderItem = function OrderItem(props) {
  var classPrefix = 'm-orders-item';
  var _props$data = props.data,
      order_number = _props$data.order_number,
      id = _props$data.id,
      time = _props$data.processed_at,
      price = _props$data.total_price,
      items = _props$data.item_list,
      showDelete = _props$data.show_delete,
      status = _props$data.status,
      currency = _props$data.currency_symbol;


  return _react2.default.createElement(
    'li',
    { className: classPrefix + ' ' + _util.color.border('hr') + ' ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
    _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement(
        'span',
        { className: (0, _util.color)('subText') + ' ' + (0, _util.font)('secTitle') },
        time
      ),
      !!showDelete && _react2.default.createElement(_Icon2.default, { type: 'delete' })
    ),
    _react2.default.createElement(
      'div',
      { className: 'item-body' },
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Link2.default,
          { className: '' + (0, _util.color)('brand'), href: '/order_details/?id=' + id },
          'Order Details'
        )
      )
    )
...
/** 订单项-手机版 **/
var OrderItemMobile = function OrderItemMobile(props) {
  var classPrefix = 'm-orders-itemMobile';
  var _props$data2 = props.data,
      order_number = _props$data2.order_number,
      id = _props$data2.id,
      time = _props$data2.processed_at,
      price = _props$data2.total_price,
      items = _props$data2.item_list,
      showDelete = _props$data2.show_delete,
      status = _props$data2.status,
      currency = _props$data2.currency_symbol;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _Button2.default,
        { type: 'ghost', href: '/order_details/?id=' + id },
        'Order Details'
      )
    )
  );
...
var Items = function Items(props) {
  ...
  if (items && items.length) {
    ...
    if (length === 1) {
      var _items$ = items[0],
          img = _items$.product_img,
          id = _items$.product_id,
          name = _items$.product_name,
          remark = _items$.item_remark,
      ...
      res = _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Link2.default,
          { href: '/products/?id=' + id, className: 'item-photo' },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            { className: '' + (0, _util.font)('secTitle') },
            '\xD7',
            quantity
          )
        )
      ...
      res = _react2.default.createElement(
        'div',
        null,
        items.slice(0, 2).map(function (_ref2) {
          var img = _ref2.product_img,
              id = _ref2.product_id,
              spu = _ref2.spu_code,
              sku = _ref2.sku_code;
          return _react2.default.createElement(
            _Link2.default,
            { href: '/products/?id=' + id, className: 'item-photo', key: id + spu + sku },
            _react2.default.createElement('img', { src: img })
          );
        }),
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Orders.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Orders.less");
...
// module
exports.push([module.i, "/** Search **/\n/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-orders-header {\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n  padding: 0.2rem 0 0.3rem 0.2rem;\n}\n.m-orders-header p {\n  display: inline-block;\n}\n.m-orders-header p:nth-of-type(1) {\n  width: 50%;\n}\n.m-orders-header p:nth-of-type(2) {\n  width: 14%;\n  margin-left: 16%;\n  text-align: center;\n}\n.m-orders-header p:nth-of-type(3) {\n  width: 20%;\n  text-align: center;\n}\n.m-orders-list {\n  margin-bottom: 0.4rem;\n}\n.m-orders-item {\n  padding: 0.32rem 0 0.38rem 0.2rem;\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n}\n.m-orders-item .item-body > div:nth-of-type(1) {\n  width: 50%;\n  text-align: left;\n  display: flex;\n}\n.m-orders-item .item-body > div:nth-of-type(2) {\n  width: 16%;\n  padding-left: 0.1rem;\n}\n.m-orders-item .item-body > div:nth-of-type(3) {\n  width: 14%;\n}\n.m-orders-item .item-body > div:nth-of-type(4) {\n  width: 20%;\n}\n.m-orders-itemMobile {\n  padding: 0.25rem 0;\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n}\n.m-orders-itemMobile .item-header span {\n  margin-left: 0.1rem;\n}\n.m-orders-itemMobile .item-header .bc-icon {\n  margin-right: 0 !important;\n  padding-left: 0.1rem;\n}\n.m-orders-itemMobile .item-body > div:nth-of-type(1) {\n  width: 75%;\n  text-align: left;\n  display: flex;\n}\n.m-orders-itemMobile .item-body > div:nth-of-type(2) {\n  width: 25%;\n  text-align: right;\n}\n.m-orders-itemMobile .item-body > div:nth-of-type(2) p {\n  margin: 0.1rem 0;\n}\n.m-orders .item-header {\n  line-height: 0.28rem;\n}\n.m-orders .item-header strong {\n  font-weight: normal;\n}\n.m-orders .item-header span {\n  margin-left: 0.2rem;\n}\n.m-orders .item-header .bc-icon {\n  float: right;\n  line-height: 0.28rem;\n  margin-right: 0.2rem;\n  opacity: .5;\n  cursor: pointer;\n}\n.m-orders .item-header .bc-icon:hover {\n  opacity: 1;\n}\n.m-orders .item-body {\n  margin-top: 0.32rem;\n  display: flex;\n  text-align: center;\n  align-items: center;\n}\n.m-orders .item-footer {\n  text-align: right;\n  margin-top: 0.15rem;\n}\n.m-orders .item-photo {\n  width: 26.67%;\n  margin-right: 4.44%;\n  flex-shrink: 0;\n}\n.m-orders .item-photo img {\n  width: 100%;\n  height: auto;\n  display: block;\n}\n.m-orders .item-desc {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n.m-orders .item-desc span {\n  margin: 0.05rem 0;\n  display: block;\n}\n.m-orders .item-more {\n  width: 26.67%;\n  background: linear-gradient(to right, #f6f6f6, rgba(238, 238, 238, 0));\n  display: flex;\n  flex-direction: column;\n  padding-left: 4%;\n  justify-content: center;\n}\n.m-orders .m-pagination {\n  text-align: right;\n}\n.m-orders-none {\n  text-align: center;\n}\n.m-orders-none > i {\n  display: block;\n  width: 2rem;\n  height: 2rem;\n  margin: 0.4rem auto;\n  background: #F4F2F3;\n  border-radius: 50%;\n}\n.m-orders-none .bc-button {\n  margin-top: 0.3rem;\n  margin-bottom: 0.4rem;\n}\n", ""]);
      ...
      return _react2.default.createElement(
        ...
        !this.props.scrollLoad && _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            {
              className: 'button-prev ' + (0, _util.color)('text') + ' ' + _util.color.border('border') + ' ' + _util.color.bg('button') + ' ' + (0, _util.font)('text') + ' ',
              disabled: pageNo <= 1,
              onClick: this.handleChangePage.bind(this, pageNo - 1) },
            _react2.default.createElement(_Icon2.default, {
              type: 'back',
              className: '' + (0, _util.font)('subText'),
              color: ''
            }),
            this.model.prev
          ),
            ...
            buttonGroup.map(function (page, index) {
              return page ? _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'button',
                  {
                    className: (0, _util.color)('text') + ' ' + _util.color.border('border') + ' ' + _util.color.bg('button') + ' ' + (0, _util.font)('text') + ' ' + (page == pageNo ? 'active' : ''),
          ...
          _react2.default.createElement(
            'button',
            {
              className: 'button-next ' + (0, _util.color)('text') + ' ' + _util.color.border('border') + ' ' + _util.color.bg('button') + ' ' + (0, _util.font)('text'),
        ...
        this.props.scrollLoad && pageNo >= totalPage && _react2.default.createElement(
          'p',
          { className: 'm-pagination-noMore ' + (0, _util.color)('subText') + ' ' + (0, _util.font)('text') },
          'No More'
        )
      );
    }
