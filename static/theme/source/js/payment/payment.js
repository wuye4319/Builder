...
var Radio = function (_React$Component) {
  ...
  _createClass(Radio, [{
    ...
    value: function render() {
      ...
      var classPrefix = Radio.classPrefix;
      var _props = this.props,
          _props$name = _props.name,
          name = _props$name === undefined ? 'defaultName' : _props$name,
      ...
      var checkedValue = defaultValue || this.state.defaultValue;
      var checked = checkedValue === value;

      return _react2.default.createElement(
        'label',
        { className: (0, _util.setClass)((_setClass = {}, _defineProperty(_setClass, className, className), _defineProperty(_setClass, classPrefix + '-wrapper', 1), _defineProperty(_setClass, classPrefix + '-checked', checked), _defineProperty(_setClass, classPrefix + '-disabled', disabled), _setClass))
        },
        _react2.default.createElement(
          ...
          _react2.default.createElement('i', { className: (0, _util.setClass)((_setClass2 = {}, _defineProperty(_setClass2, classPrefix + '-icon', 1), _defineProperty(_setClass2, 'checked', checked), _defineProperty(_setClass2, 'disabled', disabled), _setClass2)) })
        ),
        _react2.default.createElement(
          'span',
...
var _module = { Payment: _Payment2.default
  /** modules **/
...
var PaymentPage = function (_React$Component) {
  ...
  function PaymentPage() {
    ...
    return _possibleConstructorReturn(this, (PaymentPage.__proto__ || Object.getPrototypeOf(PaymentPage)).apply(this, arguments));
  }
...
var _purchase = __webpack_require__(44);
...
var Payment = function (_React$Component) {
  ...
  function Payment() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Payment.__proto__ || Object.getPrototypeOf(Payment)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      orderInfo: {
        address: '',
        cancel_reason: '',
        cancelled_at: null,
      ...
      modal: false,
      subTotal: 0
    }, _this.orderId = (0, _util.query2Obj)()['order_id'], _this.tradeNo = (0, _util.query2Obj)()['trade_no'], _this.toggleOrder = function () {
      var showOrder = _this.state.showOrder;

      if (showOrder) {
        _this.summaryWrap.style.height = '0px';
      } else {
        var oHeight = _this.orderSummary.offsetHeight;
        _this.summaryWrap.style.height = oHeight + 'px';
      }
      _this.setState({ showOrder: !showOrder });
    ...
    }, _this.selectMethod = function (e) {
      var id = e.target.value;
    }, _this.getOrderInfo = function () {
      ...
      (0, _util.fetchLite)(_user.orderDetails.bind(null, _this.orderId), {
      ...
      (0, _util.fetchLite)(_purchase.getTrade.bind(null, _this.tradeNo), {
        done: function done(res) {
          var data = res.data;
          _this.setState({
    ...
    }, _this.goPayResult = function () {
      _Link2.default.goTo('/pay_result');
    }, _this.payment = function () {
      (0, _util.fetchLite)(_purchase.payment.bind(null, _this.tradeNo), {
        done: function done() {
          _this.goPayResult();
        }
      });
  ...
  _createClass(Payment, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          showOrder = _state.showOrder,
          modal = _state.modal,
          orderInfo = _state.orderInfo,
          paymentList = _state.paymentList,
          defaultMethod = _state.defaultMethod,
          priceInfo = _state.priceInfo;

      return _react2.default.createElement(
        'div',
        { className: 'm-payment-wrap l-centerBlock' },
        _react2.default.createElement(
          'div',
          { className: 'payment-content l-mobile-payment-content' },
          _react2.default.createElement(
            'div',
            ...
            !pageMode && _react2.default.createElement(
              ...
              _react2.default.createElement(
                'p',
                { className: 'toggle-order', onClick: this.toggleOrder },
                _react2.default.createElement(
                  'button',
                  null,
                  'Hide order summary'
                ),
                _react2.default.createElement(_Icon2.default, { type: 'unfold', className: showOrder ? 'i-up' : 'i-down' })
              )
            ),
            !!pageMode && _react2.default.createElement(
              'div',
              { className: 'l-mobile-method-order' },
              _react2.default.createElement(
                'div',
                { className: 'toggle-order', onClick: this.toggleOrder },
                _react2.default.createElement(_Icon2.default, { type: 'menu' }),
                _react2.default.createElement(
                  'span',
                  null,
                  'Order details'
              ...
              _react2.default.createElement(
                ...
                { className: 'all-price' },
                '$',
                !priceInfo.length ? 0.00 : priceInfo[priceInfo.length - 1].value
              )
            ),
            _react2.default.createElement(
              'div',
              { className: 'summary-wrap', ref: function ref(e) {
                  _this2.summaryWrap = e;
                } },
              _react2.default.createElement(
                'div',
                { className: 'order-summary', ref: function ref(e) {
                    _this2.orderSummary = e;
                  } },
                _react2.default.createElement(
                  'div',
                  { className: 'item-info' },
                  !pageMode && _react2.default.createElement(
                    'span',
                    { className: 'item ' + (0, _util.color)('subText') + ' ' + (0, _util.font)('text') },
                    'Recipient'
                  ),
                  _react2.default.createElement(
                    'div',
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'div',
                    { className: 'desc ' + (0, _util.color)('text') + ' ' + (0, _util.font)('text') },
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'span',
                    { className: 'item ' + (!pageMode ? (0, _util.color)('subText') : (0, _util.color)('text')) + ' ' + (0, _util.font)('text') },
                    'Delivery Method'
                  ),
                  _react2.default.createElement(
                    'div',
                ...
                _react2.default.createElement(
                  'div',
                  { className: 'item-info l-mobile-order-details' },
                  _react2.default.createElement(
                    'span',
                    { className: 'item ' + (0, _util.color)('subText') + ' ' + (0, _util.font)('text') },
                    'Order details'
                  ...
                  _react2.default.createElement(
                    ...
                    !!orderInfo.item_list && orderInfo.item_list.map(function (item, key) {
                      return _react2.default.createElement(
                        'div',
                        { className: 'order-details', key: key },
                        _react2.default.createElement('img', { src: item['product_img'], alt: item['product_name'] }),
                        _react2.default.createElement(
                          'div',
                          ...
                          _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                              'span',
                              { className: 'size' },
                              _this2.prdProps2string(item['product_props'])
                            ),
                            _react2.default.createElement(
                              'span',
                              { className: 'price' },
            ...
            _react2.default.createElement(
              'div',
              { className: 'select-methods ' + (!pageMode && showOrder ? 'up' : '') },
              !!pageMode && _react2.default.createElement(
                'h3',
                null,
                'Payment method'
              ),
              !!paymentList.length && _react2.default.createElement(
                RadioGroup,
                {
                  name: 'payment-method',
                  value: defaultMethod.name,
                  onChange: this.selectMethod },
                paymentList.map(function (item, key) {
                  return _react2.default.createElement(
                    _Radio2.default,
                    { value: item.name, className: 'first', key: key },
                    _react2.default.createElement(
                      'section',
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'div',
                          { className: 'logo' },
                          _react2.default.createElement('img', { src: '/source/img/paymentMethod.png', alt: '' })
                        ),
                        _react2.default.createElement(
                          'div',
                          { className: 'img-icon' },
                          _react2.default.createElement('img', { src: '/source/img/icon_pay_mastercard.png', alt: '' }),
                          _react2.default.createElement('img', { src: '/source/img/icon_pay_visa.png', alt: '' }),
                          _react2.default.createElement('img', { src: '/source/img/icon_pay_amex.png', alt: '' })
                        )
                      ),
                      _react2.default.createElement(
                        'p',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _Link2.default,
                { className: 'back', href: '/order_confirm' },
              ...
              _react2.default.createElement(
                _Button2.default,
                { className: 'confirm', onClick: this.payment },
                'PAY'
              ),
              modal && _react2.default.createElement(
                _react2.default.Fragment,
                null,
                _react2.default.createElement('div', { onClick: this.closeModal, className: 'peyment-modal-mask' }),
                _react2.default.createElement(
                  'div',
                  { className: 'l-mobile-payment-modal payment-modal' },
                  _react2.default.createElement(
                    'div',
                    { className: 'modal-top' },
                    _react2.default.createElement(_Icon2.default, { type: 'close', onClick: this.closeModal })
                  ),
                  _react2.default.createElement(
                    'div',
                    { className: 'warn-icon' },
                  ...
                  _react2.default.createElement(
                    'p',
                    { className: (0, _util.color)('text') + ' ' + (0, _util.font)('subTitle') },
                    'Please complete the payment on the third-party payment page. Do not close this window until the payment is completed.'
                  ),
                  _react2.default.createElement(
                    'div',
                    { className: 'paid' },
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      _Button2.default,
                      { type: 'ghost', onClick: this.closeModal },
                      'Pay for the problem and pay again'
                    )
                  )
                )
              )
          ...
          !pageMode && _react2.default.createElement(
            'div',
            { className: 'content-total' },
            priceInfo.map(function (item, key) {
              return key !== priceInfo.length ? _react2.default.createElement(
                'p',
                { key: key },
                _react2.default.createElement(
                  'span',
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Payment.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Payment.less");
...
// module
exports.push([module.i, "/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-payment-wrap {\n  width: 100%;\n}\n.m-payment-wrap .l-mobile-payment-header {\n  display: none;\n}\n.m-payment-wrap .payment-content {\n  width: 100%;\n  margin-top: 0.4rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n}\n.m-payment-wrap .payment-content .content-summary {\n  width: 54%;\n  max-width: 6.4rem;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header {\n  width: 100%;\n  margin-bottom: 0.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar {\n  height: 100%;\n  display: flex;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li {\n  margin-top: 0.1rem;\n  flex: 1;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li p {\n  width: 100%;\n  height: 0.57rem;\n  border-top: 0.02rem solid #EBE6E7;\n  font-size: 0.16rem;\n  color: #8C8185;\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  margin: 0;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li p a {\n  font-size: 0.16rem;\n  color: #8C8185;\n  cursor: default;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li p i {\n  font-size: 0.12rem;\n  margin-left: 0.1rem;\n  color: #8C8185;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li:nth-of-type(3) i {\n  color: transparent;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li p.active {\n  position: relative;\n  border-top: transparent;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li p.active a {\n  color: #302E2F;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li p.active i {\n  color: #302E2F;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li > p.active:before {\n  content: '';\n  display: block;\n  position: absolute;\n  width: 100%;\n  height: 0.04rem;\n  background-color: #302E2F;\n  top: -0.01rem;\n  left: 0;\n}\n.m-payment-wrap .payment-content .content-summary .payment-header .progress-bar li > p.active:after {\n  content: '';\n  display: block;\n  position: absolute;\n  width: 0.2rem;\n  height: 0.2rem;\n  background-color: #FFF;\n  border: 0.04rem solid #302E2F;\n  box-sizing: border-box;\n  border-radius: 50%;\n  top: 0.01rem;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n.m-payment-wrap .payment-content .content-summary .method-order {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 0.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .method-order h3 {\n  font-size: 0.2rem;\n  color: #302E2F;\n  line-height: 0.2rem;\n  margin: 0;\n}\n.m-payment-wrap .payment-content .content-summary .method-order p.toggle-order {\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n  margin: 0;\n  font-size: 0.16rem;\n  color: #302E2F;\n  line-height: 0.2rem;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n}\n.m-payment-wrap .payment-content .content-summary .method-order p.toggle-order button {\n  border: 0;\n  background: transparent;\n  height: 100%;\n  outline: none;\n  font-size: 0.16rem;\n  color: #302E2F;\n  cursor: pointer;\n}\n.m-payment-wrap .payment-content .content-summary .method-order p.toggle-order i {\n  margin-left: 0.15rem;\n  font-size: 0.12rem;\n  color: #8B8185;\n  transition: transform 0.5s linear;\n}\n.m-payment-wrap .payment-content .content-summary .method-order p.toggle-order i.i-up {\n  transform: rotate(180deg);\n}\n.m-payment-wrap .payment-content .content-summary .summary-wrap {\n  height: 0;\n  overflow: hidden;\n  transition: height 0.5s linear;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary {\n  width: 100%;\n  border: 1px solid #EBE6E7;\n  box-sizing: border-box;\n  padding: 0.4rem 0.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info {\n  display: flex;\n  flex-wrap: wrap;\n  margin-bottom: 0.16rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info span.item {\n  width: 1.8rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.desc {\n  margin: 0;\n  flex: 1;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.desc span.uname {\n  margin-right: 0.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap {\n  flex: 1;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details {\n  display: flex;\n  align-items: center;\n  margin-bottom: 0.2rem;\n  flex-wrap: wrap;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details img {\n  display: block;\n  width: 0.8rem;\n  height: 0.8rem;\n  margin-right: 0.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details div.details-list {\n  flex: 1;\n  min-width: 2.3rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details div.details-list a {\n  display: flex;\n  width: 100%;\n  justify-content: space-between;\n  margin-bottom: 0.1rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details div.details-list a span.brand,\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details div.details-list a span.count,\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details div.details-list a span.price {\n  font-size: 0.16rem;\n  color: #302E2F;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details div.details-list a span.brand {\n  margin-right: 0.1rem;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  line-clamp: 2;\n  -webkit-box-orient: vertical;\n  word-break: break-all;\n  overflow: hidden;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details div.details-list a span.size {\n  font-size: 0.16rem;\n  color: #002526;\n  line-height: 0.16rem;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info div.lists-wrap div.order-details:last-child {\n  margin-bottom: 0;\n}\n.m-payment-wrap .payment-content .content-summary .order-summary .item-info:last-of-type {\n  margin-bottom: 0;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods.up {\n  margin-top: 0.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods {\n  width: 100%;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper {\n  display: flex;\n  flex-wrap: wrap;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper {\n  width: 100%;\n  padding: 0.4rem 0.2rem;\n  box-sizing: border-box;\n  background: #FFFFFF;\n  border: 0.02rem solid transparent;\n  display: flex;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper span.bc-radio.first {\n  margin-top: 0.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper .bc-radio-label {\n  flex: 1;\n  height: auto;\n  padding: 0 0 0 0.23rem;\n  font-size: 0.18rem;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper .bc-radio-label section.address-info div.logo-sprite {\n  height: 0.4rem;\n  line-height: 0.4rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper .bc-radio-label section.address-info div.logo-sprite div.logo {\n  width: 0.4rem;\n  height: 0.4rem;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper .bc-radio-label section.address-info div.logo-sprite div.logo img {\n  width: 100%;\n  height: 100%;\n  display: block;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper .bc-radio-label section.address-info div.logo-sprite div.img-icon img {\n  width: 0.4rem;\n  height: 0.28rem;\n  margin: 0 0.1rem;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-wrapper .bc-radio-label section.address-info p {\n  line-height: 0.24rem;\n}\n.m-payment-wrap .payment-content .content-summary .select-methods .bc-radio-group-wrapper .bc-radio-checked {\n  border: 0.02rem solid #B2AFB0;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin: 0.2rem 0;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm a {\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n  display: flex;\n  align-items: center;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm a i {\n  font-size: 0.12rem;\n  color: #8B8185;\n  margin-right: 0.12rem;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm a span {\n  line-height: 0.18rem;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm button.confirm {\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm .peyment-modal-mask {\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  z-index: 1000;\n  top: 0;\n  left: 0;\n  background: rgba(0, 0, 0, 0.5);\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal {\n  width: 6.4rem;\n  position: fixed;\n  z-index: 1100;\n  background: #FFF;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal .modal-top {\n  box-sizing: border-box;\n  padding: 0.2rem 0.2rem 0 0;\n  text-align: right;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal .modal-top i {\n  font-size: 0.2rem;\n  cursor: pointer;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal div.warn-icon {\n  padding: 0.4rem;\n  text-align: center;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal div.warn-icon i {\n  color: #1890FF;\n  font-size: 1.2rem;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal p {\n  padding: 0 0.4rem;\n  text-align: center;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal div.paid {\n  padding: 0.36rem 0.4rem 0.2rem 0.4rem;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal div.paid button {\n  width: 100%;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal div.problem {\n  padding: 0 0.4rem 0.4rem;\n}\n.m-payment-wrap .payment-content .content-summary .payment-confirm div.payment-modal div.problem button {\n  width: 100%;\n}\n.m-payment-wrap .payment-content .content-total {\n  max-width: 480px;\n  width: 40%;\n  background: #FBFAFA;\n  padding: 0.4rem 4.3%;\n  box-sizing: border-box;\n}\n.m-payment-wrap .payment-content .content-total p {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  margin: 0 0 0.2rem;\n  font-size: 0.16rem;\n  color: #302E2F;\n  line-height: 0.16rem;\n}\n.m-payment-wrap .payment-content .content-total .total-price {\n  width: 100%;\n  border-top: 0.01rem solid #EBE6E7;\n  padding-top: 0.32rem;\n  display: flex;\n  align-items: center;\n}\n.m-payment-wrap .payment-content .content-total .total-price span {\n  display: block;\n}\n.m-payment-wrap .payment-content .content-total .total-price .total {\n  font-size: 0.2rem;\n  color: #302E2F;\n  flex: 1;\n}\n.m-payment-wrap .payment-content .content-total .total-price .kind {\n  font-size: 0.16rem;\n  color: #B2AFB0;\n}\n.m-payment-wrap .payment-content .content-total .total-price .all {\n  font-size: 0.36rem;\n  color: #302E2F;\n  margin-left: 0.18rem;\n}\n@media screen and (max-width: 749px) {\n  .m-payment-wrap {\n    width: 100%;\n  }\n  .m-payment-wrap .l-mobile-payment-header {\n    display: flex;\n    width: 100%;\n    height: 0.88rem;\n    box-sizing: border-box;\n    padding: 0.28rem 0.4rem;\n  }\n  .m-payment-wrap .l-mobile-payment-header .nav-btn {\n    width: 0.32rem;\n    height: 0.32rem;\n    margin-right: 0.78rem;\n    border: 1px solid #000;\n    display: block;\n  }\n  .m-payment-wrap .l-mobile-payment-header .logo-img {\n    flex: 1;\n  }\n  .m-payment-wrap .l-mobile-payment-header .logo-img img {\n    display: block;\n    width: 1.2rem;\n    height: 0.24rem;\n    margin: 0 auto;\n  }\n  .m-payment-wrap .l-mobile-payment-header .search-cart {\n    width: 1.1rem;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    font-size: 0.2rem;\n  }\n  .m-payment-wrap .payment-content {\n    padding: 0;\n    margin-top: 0;\n  }\n  .m-payment-wrap .payment-content div.content-summary {\n    width: 100%;\n    max-width: 100%;\n    box-sizing: border-box;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.l-mobile-method-order {\n    width: 100%;\n    padding: 0.17rem 0.2rem;\n    box-sizing: border-box;\n    background: #FBFAFA;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.l-mobile-method-order div.toggle-order {\n    -webkit-tap-highlight-color: transparent;\n    -moz-tap-highlight-color: transparent;\n    display: flex;\n    align-items: center;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.l-mobile-method-order div.toggle-order span {\n    display: block;\n    padding: 0 0.1rem;\n    font-size: 0.2rem;\n    color: #302E2F;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.l-mobile-method-order span.all-price {\n    font-size: 0.2rem;\n    color: #302E2F;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.l-mobile-method-order i.bc-icon-unfold {\n    font-size: 0.12rem;\n    transition: transform 0.5s linear;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.l-mobile-method-order i.i-up {\n    transform: rotate(180deg);\n  }\n  .m-payment-wrap .payment-content div.content-summary div.order-summary {\n    padding: 0.4rem 0.2rem;\n    border-right: 0;\n    border-left: 0;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.order-summary .l-mobile-order-details {\n    flex-wrap: wrap;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.order-summary .l-mobile-order-details span.item {\n    width: 100%;\n    padding: 0.2rem 0;\n    border-top: 0.01rem solid #EEE9EB;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.order-summary .l-mobile-order-details div.lists-wrap {\n    width: 100%;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.select-methods {\n    padding: 0.2rem 0.2rem;\n    box-sizing: border-box;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.select-methods h3 {\n    margin: 0 0 0.2rem 0;\n    font-size: 0.2rem;\n    color: #302E2F;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.select-methods .bc-radio-group-wrapper label.bc-radio-wrapper {\n    padding: 0.2rem;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm {\n    padding: 0 0.2rem;\n    flex-direction: column-reverse;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm button.confirm {\n    width: 100%;\n    margin-bottom: 0.4rem;\n    -webkit-tap-highlight-color: transparent;\n    -moz-tap-highlight-color: transparent;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm .l-mobile-payment-modal {\n    width: 90%;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm .l-mobile-payment-modal .warn-icon {\n    padding: 0.2rem;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm .l-mobile-payment-modal .warn-icon i {\n    font-size: 0.8rem;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm .l-mobile-payment-modal P {\n    padding: 0 0.2rem;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm .l-mobile-payment-modal .paid {\n    padding: 0.2rem;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm .l-mobile-payment-modal .problem {\n    padding: 0 0.2rem 0.3rem;\n  }\n  .m-payment-wrap .payment-content div.content-summary div.payment-confirm .l-mobile-payment-modal .problem button {\n    padding: 0.08rem 0;\n  }\n}\n", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/less-loader/dist/index.js!./Radio.less", function() {
			var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/less-loader/dist/index.js!./Radio.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "/* 阴影 */\n/**/\n/*旋转类*/\n.bc-radio-wrapper {\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n  display: block;\n  cursor: pointer;\n  line-height: 0;\n}\n.bc-radio-wrapper span.bc-radio {\n  display: inline-block;\n  vertical-align: middle;\n  width: 16px;\n  height: 16px;\n  position: relative;\n}\n.bc-radio-wrapper span.bc-radio i.bc-radio-icon {\n  display: block;\n  box-sizing: border-box;\n  width: 16px;\n  height: 16px;\n  background: #fff;\n  border: 1px solid #B2AFB0;\n  border-radius: 50%;\n}\n.bc-radio-wrapper span.bc-radio i.bc-radio-icon.checked {\n  border: 1px solid #D1343E;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.bc-radio-wrapper span.bc-radio i.bc-radio-icon.disabled {\n  background: #F7F6F6;\n  border: 1px solid #DBD8D9;\n}\n.bc-radio-wrapper span.bc-radio i.bc-radio-icon.checked:after {\n  content: '';\n  display: block;\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background-color: #D1343E;\n}\n.bc-radio-wrapper span.bc-radio-label {\n  display: inline-block;\n  vertical-align: middle;\n  height: 16px;\n  padding: 0 10px;\n  font-size: 14px;\n  line-height: 16px;\n  color: #302E2F;\n}\n.bc-radio-wrapper input {\n  display: block;\n  width: 0px;\n  height: 0px;\n  opacity: 0;\n  position: absolute;\n  top: 0;\n  left: 0;\n  padding: 0;\n  margin: 0;\n}\n", ""]);
...
var RadioGroup = function (_React$Component) {
  ...
  function RadioGroup() {
    ...
    }, _this.createChild = function (child, key) {
      var value = _this.props.value;

      var defaultValue = value ? value : _this.state.defaultValue;
      var _this$props$name = _this.props.name,
          name = _this$props$name === undefined ? 'defaultName' : _this$props$name;

      return _react2.default.createElement(
        _react2.default.Fragment,
        null,
        _react2.default.createElement(_Radio2.default, _extends({}, child.props, {
          name: name,
  ...
  _createClass(RadioGroup, [{
    ...
    value: function render() {
      ...
      var classPrefix = RadioGroup.classPrefix;
      var _props = this.props,
          children = _props.children,
          className = _props.className;
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _util.setClass)((_setClass = {}, _defineProperty(_setClass, className, className), _defineProperty(_setClass, classPrefix + '-wrapper', 1), _setClass)) },
        _react2.default.Children.map(children, this.createChild)
      );
    }
  }]);
...
RadioGroup.classPrefix = 'bc-radio-group';
...
function getTrade(tradeNo) {
  return (0, _util.fetch)(_common.APIRoot + '/payment/trade/' + tradeNo);
}

/** 一期模拟支付 **/
function payment(tradeNo) {
  return (0, _util.fetch)(_common.APIRoot + '/payment/test/' + tradeNo, {
    method: 'PUT'
  });
}
