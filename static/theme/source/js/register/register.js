...
var _module = { Register: _Register2.default
  /** modules **/
...
var Register = function (_React$Component) {
  ...
  function Register() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Register.__proto__ || Object.getPrototypeOf(Register)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      waringInfo: ''
    }, _this.clearValue = function (key) {
      _this.setState(function () {
        return _defineProperty({}, key, '');
      });
    }, _this.changeValue = function (key, e) {
      var value = e.target.value;
      _this.setState(function () {
        return _defineProperty({}, key, value);
      });
    }, _this.handleCheckEmail = function () {
      ...
      var emailReg = /^[a-z0-9]+([._\\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$/g;
    ...
    }, _this.handleCheckFirstPassword = function () {
      var firstPassword = _this.state.firstPassword;
      ...
      var passwordReg = /^[0-9a-zA-Z]{6,20}$/g;
      var result = passwordReg.test(firstPassword);
      if (!result) {
        _this.setState(function () {
          return {
            checkFirstPassword: false,
    ...
    }, _this.handleCheckConfirmPassword = function () {
      var _this$state = _this.state,
          firstPassword = _this$state.firstPassword,
      ...
      var _this$state2 = _this.state,
          ...
          checkEmail = _this$state2.checkEmail,
          firstPassword = _this$state2.firstPassword,
          checkFirstPassword = _this$state2.checkFirstPassword,
          confirmPassword = _this$state2.confirmPassword,
          checkConfirmPassword = _this$state2.checkConfirmPassword;
      ...
      if (!eMail) {
        ...
        _this.postDataRegister();
      }
    }, _this.postDataRegister = function () {
      var _this$state3 = _this.state,
          firstName = _this$state3.firstName,
          lastName = _this$state3.lastName,
          eMail = _this$state3.eMail,
          firstPassword = _this$state3.firstPassword,
      ...
      (0, _util.fetchLite)(_user.register.bind(null, {
        firstName: firstName,
        lastName: lastName,
        eMail: eMail,
        ...
        confirmPassword: confirmPassword
          ...
          _Link2.default.goTo('/account_information/');
        }
      });
  ...
  _createClass(Register, [{
    ...
    value: function render() {
      var _state = this.state,
          ...
          firstPassword = _state.firstPassword,
          eMail = _state.eMail,
          confirmPassword = _state.confirmPassword,
          checkEmail = _state.checkEmail,
          checkFirstPassword = _state.checkFirstPassword,
          checkConfirmPassword = _state.checkConfirmPassword,
          waringInfo = _state.waringInfo;

      return _react2.default.createElement(
        'div',
        { className: 'm-register-wrap  l-centerBlock' },
        _react2.default.createElement(
          'div',
          { className: 'register-start' },
          _react2.default.createElement(
            'h2',
            { className: 'register-title ' + (0, _util.font)('title') + ' ' + (0, _util.color)('title') },
            'CREATE ACCOUNT'
          ),
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            'h3',
            { className: (0, _util.font)('f-secTitle') + ' ' + (0, _util.color)('title') },
            'FIRST NAME'
          ),
          ...
          _react2.default.createElement(
            _Button2.default,
            { className: 'create', onClick: this.createAccount },
            'CREATE'
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              _Link2.default,
              { href: '/login', className: (0, _util.font)('text') + ' ' + (0, _util.color)('subText') },
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Register.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/index.js!./Register.less");
...
// module
exports.push([module.i, "/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-register-wrap .register-start {\n  width: 6rem;\n  margin: 0 auto;\n}\n.m-register-wrap .register-start .register-title {\n  text-align: center;\n  margin: 0.8rem 0 0.42rem;\n}\n.m-register-wrap .register-start .warn-info {\n  margin: 0 auto;\n  margin-bottom: 0.2rem;\n  color: #FF6158;\n  height: 0.24rem;\n  line-height: 0.24rem;\n}\n.m-register-wrap .register-start h3 {\n  margin-bottom: 0.1rem;\n}\n.m-register-wrap .register-start h3 span {\n  margin-left: 0.1rem;\n}\n.m-register-wrap .register-start .bc-input {\n  width: 100%;\n  margin-bottom: 0.2rem;\n}\n.m-register-wrap .register-start input.warning {\n  border: 1px solid #D1343E;\n}\n.m-register-wrap .register-start .create {\n  width: 100%;\n  margin-bottom: 0.2rem;\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n}\n.m-register-wrap .register-start .to-login {\n  margin-bottom: 0.2rem;\n  text-align: center;\n}\n.m-register-wrap .register-start .to-login a {\n  text-align: center;\n  text-decoration: underline;\n  -webkit-tap-highlight-color: transparent;\n  -moz-tap-highlight-color: transparent;\n}\n@media screen and (max-width: 749px) {\n  .m-register-wrap .register-start {\n    width: 100%;\n    padding: 0 0.2rem;\n    -webkit-box-sizing: border-box;\n    -moz-box-sizing: border-box;\n    box-sizing: border-box;\n  }\n  .m-register-wrap .register-start .register-title {\n    margin: 0.4rem 0 0.22rem;\n  }\n}\n", ""]);
...
function addressAction(params) {
  return (0, _util.fetch)(_common.APIRoot + '/address/action', {
    method: 'POST',
    body: params
  });
}
