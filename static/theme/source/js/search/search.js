...
var _module = { Search: _Search2.default
  /** modules **/
...
var _ItemsList = __webpack_require__(39);
...
var Search = function (_React$Component) {
  ...
  function Search() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Search.__proto__ || Object.getPrototypeOf(Search)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      data: null,
      keywords: decodeURIComponent((0, _util.query2Obj)().keywords || ''),
      pageSize: (_this.props.rows || 2) * 4,
      page: 1,
      ...
      return (0, _page.searchProducts)({ keywords: keywords, pageSize: pageSize, page: n || page, sort: sort }).then(function (data) {
        if (data.state === 0) {
          var _data = data.data;
          var list = _data.product_list || [];
          var pageMode = _this.props.pageMode;

          _this.setState({
            data: pageMode === 1 ? (_this.state.data || []).concat(list) : list,
            total: _data.total || 0,
    ...
    }, _this.handleChangeSort = function (e) {
      var value = e.target.value;
      _this.setState(function (state) {
        var res = { sort: value };
        if (_this.props.pageMode === 1) {
          res.page = 1;
      ...
      _Link2.default.goTo('/search/?keywords=' + encodeURIComponent(_this.input.value.trim()));
    }, _this.enter2Search = function (event) {
    ...
    }, _this.dataPadding = function (editLength) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      var classPrefix = Search.classPrefix,
          sortMap = Search.sortMap;
      ...
      var editLength = (this.props.config.rows || 2) * 4;
      ...
      return _react2.default.createElement(
        'div',
        { className: classPrefix + ' l-centerBlock ' + (0, _util.setClass)({}) },
        _react2.default.createElement(
          'div',
          { className: classPrefix + '-search' },
          _react2.default.createElement(_Input2.default, {
            defaultValue: keywords,
            getInput: function getInput(ref) {
              _this2.input = ref;
            },
            ...
            className: (0, _util.setClass)({ error: error })
          }),
          _react2.default.createElement(
            _Button2.default,
        ...
        data ? data.length ? _react2.default.createElement(
          'div',
          { className: classPrefix + '-toolbar ' + _util.color.border('border') + ' clearfix' },
          _react2.default.createElement(
            'h3',
          ...
          _react2.default.createElement(
            'span',
            null,
            pageMode === 0 && _react2.default.createElement(
              'i',
            ...
            _react2.default.createElement(
              _Select2.default,
              { value: sort, onChange: this.handleChangeSort },
              sortMap.map(function (_ref2) {
                var key = _ref2.key,
                    label = _ref2.label;
                return _react2.default.createElement(
                  'option',
          ...
          _react2.default.createElement(
            'h3',
            { className: (0, _util.color)('title') + ' ' + (0, _util.font)('subTitle') },
            'Very sorry! No products found for "',
            keywords,
            '"'
          ),
          _react2.default.createElement(
        ...
        _react2.default.createElement(_ItemsList2.default, { data: data }),
        !!(data && data.length) && _react2.default.createElement(_Pagination2.default, {
          totalPage: totalPage,
          totalRow: total,
          pageNo: page,
          size: pageSize,
...
Search.classPrefix = 'm-search';
Search.sortMap = [{ key: '1', label: 'New' }, { key: '2', label: 'Price high to low' }, { key: '3', label: 'Price low to high' }];
...
// module
exports.push([module.i, "/** Search **/\n/** 变量定义 **/\n/* 弹性盒子*/\n/*圆角*/\n/* 文本溢出...*/\n/* 限制文本行数*/\n/* 阴影 */\n/*旋转函数*/\n/*过度动画*/\n/*css3 动画*/\n/*css3 transform*/\n.m-search {\n  padding-bottom: 0.5rem;\n}\n.m-search-search {\n  text-align: center;\n  margin-top: 0.8rem;\n}\n.m-search-search input {\n  width: 40%;\n  border-radius: 2px 0 0 2px;\n}\n.m-search-search input.error {\n  color: #FF6158;\n}\n.m-search-search button {\n  border-radius: 0 2px 2px 0;\n}\n.m-search-toolbar {\n  margin-top: 0.8rem;\n  padding-bottom: 0.4rem;\n  border-bottom-width: 1px;\n  border-bottom-style: solid;\n  line-height: 0.4rem;\n}\n.m-search-toolbar > h3 {\n  float: left;\n}\n.m-search-toolbar > span {\n  float: right;\n}\n.m-search-toolbar > span .bc-select {\n  height: 0.4rem;\n  margin-left: 0.12rem;\n}\n.m-search-toolbar > span i {\n  font-style: normal;\n}\n.m-search-none {\n  margin: 0.6rem 24.6% 0 24.6%;\n}\n.m-search-none h3 {\n  text-align: center;\n}\n.m-search-none dl {\n  list-style: disc;\n  margin-top: 0.3rem;\n}\n.m-search-none dl dt {\n  margin-bottom: 0.12rem;\n}\n.m-search-none dl dd {\n  list-style: disc;\n}\n.l-mobile .m-search-search {\n  display: none;\n}\n.l-mobile .m-search-toolbar {\n  margin-top: 20px;\n  padding-bottom: 0.3rem;\n}\n.l-mobile .m-search.l-centerBlock {\n  padding-left: 20px;\n  padding-right: 20px;\n}\n.l-mobile .m-search-none {\n  margin: 0.4rem 0 0 0;\n}\n", ""]);
